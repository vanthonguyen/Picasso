...
class PicassoNetII(nn.Module):
    def __init__(self, num_class, stride=None, mix_components=27, use_height=False):
        ...
        self.Block.append(EncoderMeshBlock(self.EncodeChannels[0], self.EncodeChannels[1], growth_rate,
                                           ...
                                           bn_momentum=self.bn_momentum))
        self.Block.append(DualBlock(self.EncodeChannels[1], self.EncodeChannels[2], growth_rate,
                                    self.num_clusters, radius=0.1, max_iter=self.Niters[1],
                                    bn_momentum=self.bn_momentum))
    ...
    def __call__(self, vertex_in, face_in, nv_in, mf_in, facet_textures, bary_coeff, num_texture,
        ...
        feats = self.Conv0(facet_geometrics, facet_textures, bary_coeff, num_texture,
